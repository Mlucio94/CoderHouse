    ...
    return <>
        <div class="container p-0 ">
            <div class="row justify-content-center">
                <button class=" btn btn-outline-pink float-right m-1" onClick={remove} >
                ...
                <span class="text-center align-self-center m-1" >{counter}</span>
            
                <button class=" btn btn-outline-pink float-right m-1" onClick={add} >
